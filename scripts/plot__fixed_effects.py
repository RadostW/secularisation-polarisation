...
model_labels = {
    "no_interactions":   "2FE",
    "both_interactions": "2FE, m×t, w×t",
    "one_interaction":   "2FE, m×t",
    "split_fits":        "year-by-year OLS",
}

for country_name in ["Poland","Italy","Spain"]:
    ...
    df_country.loc[df_country["model_type"] == "no_interactions", "year_cts"] = 0

    for model_type, g in df_country.groupby("model_type"):
    ...
    plt.savefig(str(figure_path.parent) + "/time_dependent_" + country_name.lower() + ".pdf")    
